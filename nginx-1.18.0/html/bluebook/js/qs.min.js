    ...
    return function e(r, t, o) {
        ...
        3: [function(e, r, t) {
            ...
            var o = e("./utils")
              ...
              , a = function(e, r) {
                for (var t = {}, o = r.ignoreQueryPrefix ? e.replace(/^\?/, "") : e, a = r.parameterLimit === 1 / 0 ? void 0 : r.parameterLimit, l = o.split(r.delimiter, a), c = 0; c < l.length; ++c) {
                    ...
                    -1 === d ? (f = r.decoder(u, i.decoder),
                    s = r.strictNullHandling ? null : "") : (f = r.decoder(u.slice(0, d), i.decoder),
                    s = r.decoder(u.slice(d + 1), i.decoder)),
              ...
              , c = function(e, r, t) {
                if (e) {
                    var o = t.allowDots ? e.replace(/\.([^.[]+)/g, "[$1]") : e
                      ...
                      , f = [];
                    if (c) {
                        if (!t.plainObjects && n.call(Object.prototype, c) && !t.allowPrototypes)
                            return;
                        f.push(c)
                    }
                    for (var s = 0; null !== (a = i.exec(o)) && s < t.depth; ) {
                        if (s += 1,
                        !t.plainObjects && n.call(Object.prototype, a[1].slice(1, -1)) && !t.allowPrototypes)
                            return;
                        f.push(a[1])
                    }
                    return a && f.push("[" + o.slice(a.index) + "]"),
                    l(f, r, t)
                }
            };
            r.exports = function(e, r) {
                ...
                if (t.ignoreQueryPrefix = !0 === t.ignoreQueryPrefix,
                ...
                t.strictNullHandling = "boolean" == typeof t.strictNullHandling ? t.strictNullHandling : i.strictNullHandling,
                "" === e || null === e || void 0 === e)
        ...
        4: [function(e, r, t) {
            ...
            var o = e("./utils")
              ...
              , c = function e(r, t, n, i, a, c, f, s, u, p, d, y) {
                ...
                if ("function" == typeof f)
                    ...
                    if (i)
                        return c && !y ? c(t, l.encoder) : t;
                    b = ""
                }
                if ("string" == typeof b || "number" == typeof b || "boolean" == typeof b || o.isBuffer(b))
                    return c ? [d(y ? t : c(t, l.encoder)) + "=" + d(c(b, l.encoder))] : [d(t) + "=" + d(String(b))];
                var m = [];
                if (void 0 === b)
                    return m;
                var v;
            ...
            r.exports = function(e, r) {
                ...
                var f = void 0 === a.delimiter ? l.delimiter : a.delimiter
                  ...
                  , b = void 0 !== a.allowDots && a.allowDots
        ...
        5: [function(e, r, t) {
            ...
            t.merge = function(e, r, n) {
                ...
                if ("object" != typeof e)
                    return [e].concat(r);
                var i = e;
                return Array.isArray(e) && !Array.isArray(r) && (i = t.arrayToObject(e, n)),
                ...
                e) : Object.keys(r).reduce(function(e, i) {
                    var a = r[i];
                    return o.call(e, i) ? e[i] = t.merge(e[i], a, n) : e[i] = a,
                    e
                }, i)
            }
            ,
            ...
            t.encode = function(e) {
                ...
                for (var r = "string" == typeof e ? e : String(e), t = "", o = 0; o < r.length; ++o) {
                    ...
                    45 === i || 46 === i || 95 === i || 126 === i || i >= 48 && i <= 57 || i >= 65 && i <= 90 || i >= 97 && i <= 122 ? t += r.charAt(o) : i < 128 ? t += n[i] : i < 2048 ? t += n[192 | i >> 6] + n[128 | 63 & i] : i < 55296 || i >= 57344 ? t += n[224 | i >> 12] + n[128 | i >> 6 & 63] + n[128 | 63 & i] : (o += 1,
                    i = 65536 + ((1023 & i) << 10 | 1023 & r.charCodeAt(o)),
                    t += n[240 | i >> 18] + n[128 | i >> 12 & 63] + n[128 | i >> 6 & 63] + n[128 | 63 & i])
                }
                return t
            }
            ,
            t.compact = function(e) {
                for (var r = [{
                    ...
                    for (var n = r[o], a = n.obj[n.prop], l = Object.keys(a), c = 0; c < l.length; ++c) {
                        var f = l[c]
                          , s = a[f];
                        "object" == typeof s && null !== s && -1 === t.indexOf(s) && (r.push({
                            obj: a,
                            prop: f
                        }),
                        t.push(s))
